...
#    rospy.loginfo("""Reconfigure Request:  {double_param}, {bool_param}, {size}""".format(**config))  #NEW ADDED
    return config
...
class CalibrateAngular():
    def __init__(self):
        ...
        srv = Server(CalibrateAngularConfig, callback)
        ...
        while not rospy.is_shutdown():
            ...
            if self.start_test:
                ...
                rospy.set_param('start_test', False)
        rospy.spin()
